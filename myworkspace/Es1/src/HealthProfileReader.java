...
public class HealthProfileReader {
	...
	public static void createPerson(String firstname, String lastname, Date birthdate) {
		Person p = new Person(firstname,lastname,null,birthdate);
		database.put(firstname+" "+lastname, p);
	}
	
	public static void displayHealthProfile(Long personId) {
		displayHealthProfile(personId.toString());
	}
	
	public static void displayHealthProfile(String personId) {
	...
	public static void updateHealthProfile(Long personId, Double height, Double weight) {
		updateHealthProfile(personId.toString(), height, weight);
	}
	
	public static void updateHealthProfile(String personId, Double height, Double weight) {
		Person p= database.get(personId);
		if(p != null) {
